...
* 🛡️ **加密：** 每个真实会话都要求 Signed 或 Signed+Encrypted（Basic256Sha256、Aes128_Sha256_RsaOaep 或 Aes256_Sha256_RsaPss）——未加密的 `SecurityPolicy.None` 连接会被真正拒绝,而不仅仅是不建议使用。
...
├── mejoras_futuras.txt  # 完整、诚实地列出哪些内容被有意推迟及原因
└── README.md
```
